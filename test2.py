...
def search_flights(
    ...
    try:
        ...
        response = amadeus.shopping.flight_offers_search.post(**search_params)
...
if __name__ == "__main__":
    flight = {'adults': 1,"originLocationCode": "JFK", 'destinationLocationCode': 'DEN', 'returnDate': '2025-05-31', 'departureDate': '2025-05-27',"max":1}
    data =amadeus.shopping.flight_offers_search.get(**flight)
    print(data.data)
    # print("price",get_flight_details(data.data[0]))
